...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {{-- On The List --}}
            <div
                class="bg-yellow-100 border-l-8 border-yellow-500 rounded-2xl shadow-md p-6 text-center transition-all hover:shadow-xl">
            ...
            {{-- Pending --}}
            <div
                class="bg-blue-100 border-l-8 border-blue-500 rounded-2xl shadow-md p-6 text-center transition-all hover:shadow-xl">
            ...
            {{-- Solved --}}
            <div
                class="bg-green-100 border-l-8 border-green-500 rounded-2xl shadow-md p-6 text-center transition-all hover:shadow-xl">
            ...
            {{-- Total Tickets --}}
            <div
                class="bg-red-100 border-l-8 border-red-500 rounded-2xl shadow-md p-6 text-center transition-all hover:shadow-xl">
                    ...
                    options: {
                        ...
                        scales: {
                            y: {
                                beginAtZero: true,
                                ticks: {
                                    stepSize: 1, // Hindari angka .5
                                    precision: 0 // Hapus angka desimal
                                },
                                suggestedMax: Math.max(...{!! json_encode($chartData) !!}) + 1, // Tambah sedikit biar lega
                                title: {
                                    display: true,
                                }
                            },
